        ...
        <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl border border-white/15 bg-linear-to-b from-white/70 to-white/60 shadow-2xl backdrop-blur">
          ...
          <div className="px-6 py-8 sm:px-8 space-y-6">
            ...
            <div className="flex gap-4">
              <div className="shrink-0 text-3xl">🖱️</div>
              <div>
                <h3 className="font-bold text-black text-lg">2. Feste Zone belegen</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-black/70 text-sm mt-1">Unten über die Thumbnails zwischen Vorderseite, Rückseite und Seiten wechseln. Mit ↺/↻ drehst du das Logo in der aktiven Zone.</p>
              </div>
            </div>
